...
| `invite <player>`                 | 邀请玩家加入岛屿                  |
| `accept`                          | 接受岛屿邀请                    |
| `decline`                         | 拒绝岛屿邀请                    |
| `remove <player> [confirm]`       | 移除岛屿成员                    |
...
| 子命令                              | 说明          |
|----------------------------------|-------------|
| `setradius <ownerName> <radius>` | 修改指定玩家的岛屿半径 |
...
| 类别                   | 包含权限                                  |
|----------------------|---------------------------------------|
| **MANAGEMENT**       | 管理类：邀请/移除成员、设置角色/权限/传送点/生物群系、重命名、删除岛屿 |
...
| 表名               | 说明                           |
|------------------|------------------------------|
| `islands`        | 岛屿数据（ID、名称、所属者、坐标、半径、设置、权限等） |
