 ...
 */
public record SchematicConfig(String fileName, double normalOffsetX, double normalOffsetY, double normalOffsetZ,
                              double netherOffsetX, double netherOffsetY, double netherOffsetZ, double endOffsetX,
                              double endOffsetY, double endOffsetZ) {
