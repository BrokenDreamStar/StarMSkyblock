...
public class ColorUtils
{
    ...
    public static Map<Color, Character> getColorRGBValues() {
        return colorRGBValues;
    }

    public static Map<String, String> getColorAndTypefaceNames() {
        return colorAndTypefaceNames;
    }

    public static Map<String, String> getColorNames() {
        return colorNames;
    }

    public static Map<String, String> getTypefaceNames() {
        return typefaceNames;
    }

    public static List<FunctionalColor> getColors() {
        return colors;
    }
